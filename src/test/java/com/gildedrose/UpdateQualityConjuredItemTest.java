 ...
 */
public class UpdateQualityConjuredItemTest implements Logger{

    static Item[] items;
    static GildedRose controller;
    static final int GENERIC_DECREMENT = 1;
    static final String ITEM_NAME = "Conjured Item";
    ...
    @Test
    public void testConjuredItemBeforeSellinDate_decrementQualityBy2(){
        int initSelling = 2;
        int initQuality = 10;
    ...
    @Test
    public void testConjuredItemAfterSellinDate_decrementQualityBy2(){
        int initSelling = 0;
        int initQuality = 10;
        Item testItem = new Item(ITEM_NAME, initSelling, initQuality);
        items[0] = testItem;
        for (int i = 0 ; i < 2 ; i++){
            ...
            controller.updateQuality();
            assertEquals(initSelling - i - 1, testItem.sellIn);
            assertEquals(initQuality - 4 * (i +  GENERIC_DECREMENT), testItem.quality);
        }
        log(testItem, 2);
    }

    @Test
    public void testConjuredItemAfterSellinDate_QualityIsPositive(){
        int initSelling = 0;
        int initQuality = 0;
        Item testItem = new Item(ITEM_NAME, initSelling, initQuality);
        items[0] = testItem;
